# -*- coding: utf-8 -*-
"""GTZAN_model_test_version_3.ipynb
...
# Define normalize again (in case it’s not loaded)
def normalize(genre):
    return genre.lower().replace("-", "").replace(" ", "")
...
print(f"\n✅ All results (so far) saved live to: {output_txt}")
